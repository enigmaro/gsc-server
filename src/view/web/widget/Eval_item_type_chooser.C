...
void Eval_item_type_chooser::set_value(Eval_item::Type new_type)
{
    switch (new_type) {
    default:
    case Eval_item::Type::Boolean: type_->setSelectedButtonIndex(0); break;
    case Eval_item::Type::Scale: type_->setSelectedButtonIndex(1); break;
...
Eval_item::Type Eval_item_type_chooser::get_value() const
{
    ...
    default:
    case 0: return Eval_item::Type::Boolean;
    case 1: return Eval_item::Type::Scale;
    case 2: return Eval_item::Type::Informational;
    }
}
