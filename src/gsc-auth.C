...
{
public:
    static int main(int argc, const char* argv[], istream&, ostream&, ostream&);
                       ...
                       ostream& err)
{
    ...
    switch (argc) {
    case 1: role = User::Role::Grader; break;
                               ...
                               const string& secret)
{
    ...
    if (secret == session().get_api_key(user)) return true;
#endif
