...
public:
    ...
    get_self_eval(const Wt::Dbo::ptr<Eval_item>&,
                  const Wt::Dbo::ptr<Submission>&, bool create = true);

    static Wt::Dbo::ptr<Self_eval>
    get_self_eval(int sequence_number, const Wt::Dbo::ptr<Submission>&,
                  bool create = true);
...
public:
    ...
    void persist(Action& a)
    {
        ...
        Wt::Dbo::belongsTo(a, assignment_, "assignment",
