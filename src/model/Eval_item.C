...
J::Object Eval_item::to_json(dbo::ptr<Submission> const& as_part_of,
                             dbo::ptr<User> const& as_seen_by, bool brief) const
{
    J::Object result;
    ...
    if (! brief) {
        ...
        auto self_eval = Submission::get_self_eval(
                sequence(), as_part_of, type() == Type::Informational);
        if (self_eval) {
...
{
    switch (type) {
    case Eval_item::Type::Boolean: return o << "Boolean";
    case Eval_item::Type::Scale: return o << "Scale";
    case Eval_item::Type::Informational: return o << "Informational";
    }
}
